...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.contact_email'
        db.add_column('makahiki_profiles_profile', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.contact_text'
        db.add_column('makahiki_profiles_profile', 'contact_text', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.contact_carrier'
        db.add_column('makahiki_profiles_profile', 'contact_carrier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.contact_email'
        db.delete_column('makahiki_profiles_profile', 'contact_email')

        # Deleting field 'Profile.contact_text'
        db.delete_column('makahiki_profiles_profile', 'contact_text')

        # Deleting field 'Profile.contact_carrier'
        db.delete_column('makahiki_profiles_profile', 'contact_carrier')
    ...
    models = {
        ...
        'makahiki_profiles.profile': {
            ...
            'data_opt_in': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
