...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.setup_complete'
        db.add_column('makahiki_profiles_profile', 'setup_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.setup_complete'
        db.delete_column('makahiki_profiles_profile', 'setup_complete')
