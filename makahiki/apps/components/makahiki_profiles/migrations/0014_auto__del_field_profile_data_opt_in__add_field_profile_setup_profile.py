...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.data_opt_in'
        db.delete_column('makahiki_profiles_profile', 'data_opt_in')

        # Adding field 'Profile.setup_profile'
        db.add_column('makahiki_profiles_profile', 'setup_profile', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.data_opt_in'
        db.add_column('makahiki_profiles_profile', 'data_opt_in', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Deleting field 'Profile.setup_profile'
        db.delete_column('makahiki_profiles_profile', 'setup_profile')
