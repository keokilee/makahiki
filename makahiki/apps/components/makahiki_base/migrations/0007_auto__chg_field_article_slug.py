...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('makahiki_base_article', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True))

        # Adding index on 'Article', fields ['slug']
        db.create_index('makahiki_base_article', ['slug'])
    
    
    def backwards(self, orm):
        
        # Changing field 'Article.slug'
        db.alter_column('makahiki_base_article', 'slug', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        # Removing index on 'Article', fields ['slug']
        db.delete_index('makahiki_base_article', ['slug'])
