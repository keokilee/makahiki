...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityBase.slug'
        db.add_column('activities_activitybase', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityBase.slug'
        db.delete_column('activities_activitybase', 'slug')
