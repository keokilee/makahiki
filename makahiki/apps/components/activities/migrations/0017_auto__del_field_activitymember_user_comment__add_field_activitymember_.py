...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ActivityMember.user_comment'
        db.delete_column('activities_activitymember', 'user_comment')

        # Adding field 'ActivityMember.social_email'
        db.add_column('activities_activitymember', 'social_email', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ActivityMember.user_comment'
        db.add_column('activities_activitymember', 'user_comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'ActivityMember.social_email'
        db.delete_column('activities_activitymember', 'social_email')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 2)'}),
