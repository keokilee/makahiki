...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('activities_category', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.slug'
        db.delete_column('activities_category', 'slug')
