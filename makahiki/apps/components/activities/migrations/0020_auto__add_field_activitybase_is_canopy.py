...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityBase.is_canopy'
        db.add_column('activities_activitybase', 'is_canopy', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityBase.is_canopy'
        db.delete_column('activities_activitybase', 'is_canopy')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 9)'}),
