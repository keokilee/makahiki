...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommitmentMember.social_email'
        db.add_column('activities_commitmentmember', 'social_email', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommitmentMember.social_email'
        db.delete_column('activities_commitmentmember', 'social_email')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 15)'}),
        ...
        'activities.activitybase': {
            ...
            'is_canopy': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
