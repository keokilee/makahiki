...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.event_location'
        db.add_column('activities_activity', 'event_location', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.event_location'
        db.delete_column('activities_activity', 'event_location')
    ...
    models = {
        'activities.activity': {
            ...
            'event_location': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 4, 7)'}),
