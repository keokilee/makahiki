...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityBase.mobile_restricted'
        db.add_column('activities_activitybase', 'mobile_restricted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityBase.mobile_restricted'
        db.delete_column('activities_activitybase', 'mobile_restricted')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 19)'}),
