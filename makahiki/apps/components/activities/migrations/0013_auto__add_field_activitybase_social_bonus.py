...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityBase.social_bonus'
        db.add_column('activities_activitybase', 'social_bonus', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityBase.social_bonus'
        db.delete_column('activities_activitybase', 'social_bonus')
