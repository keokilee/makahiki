...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityBase.is_group'
        db.add_column('activities_activitybase', 'is_group', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'ActivityBase.category'
        db.alter_column('activities_activitybase', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Category'], null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'ActivityBase.is_group'
        db.delete_column('activities_activitybase', 'is_group')

        # Changing field 'ActivityBase.category'
        db.alter_column('activities_activitybase', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Category'], null=True))
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 8)'}),
        ...
        'activities.activitybase': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['activities.Category']", 'null': 'True', 'blank': 'True'}),
        ...
        'activities.activitymember': {
            ...
            'social_email': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
