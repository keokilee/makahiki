...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.enable_help'
        db.add_column('makahiki_profiles_profile', 'enable_help', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.enable_help'
        db.delete_column('makahiki_profiles_profile', 'enable_help')
