...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.canopy_karma'
        db.add_column('makahiki_profiles_profile', 'canopy_karma', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.canopy_karma'
        db.delete_column('makahiki_profiles_profile', 'canopy_karma')
