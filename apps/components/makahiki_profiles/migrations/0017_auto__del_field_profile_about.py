...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('makahiki_profiles_profile', 'about')


    def backwards(self, orm):
        
        # Adding field 'Profile.about'
        db.add_column('makahiki_profiles_profile', 'about', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
