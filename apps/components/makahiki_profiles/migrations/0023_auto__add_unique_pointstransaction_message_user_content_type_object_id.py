...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PointsTransaction', fields ['message', 'user', 'content_type', 'object_id']
        db.create_unique('makahiki_profiles_pointstransaction', ['message', 'user_id', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PointsTransaction', fields ['message', 'user', 'content_type', 'object_id']
        db.delete_unique('makahiki_profiles_pointstransaction', ['message', 'user_id', 'content_type_id', 'object_id'])
    ...
    models = {
        ...
        'makahiki_profiles.pointstransaction': {
            'Meta': {'unique_together': "(('user', 'message', 'content_type', 'object_id'),)", 'object_name': 'PointsTransaction'},
