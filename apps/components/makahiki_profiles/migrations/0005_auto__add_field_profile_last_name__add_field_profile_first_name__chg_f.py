...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('makahiki_profiles_profile', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.first_name'
        db.add_column('makahiki_profiles_profile', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Changing field 'Profile.floor'
        db.alter_column('makahiki_profiles_profile', 'floor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['floors.Floor'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Profile.last_name'
        db.delete_column('makahiki_profiles_profile', 'last_name')

        # Deleting field 'Profile.first_name'
        db.delete_column('makahiki_profiles_profile', 'first_name')

        # Changing field 'Profile.floor'
        db.alter_column('makahiki_profiles_profile', 'floor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['floors.Floor'], null=True))
