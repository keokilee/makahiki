...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.theme'
        db.delete_column('makahiki_profiles_profile', 'theme')

        # Adding field 'Profile.daily_visit_count'
        db.add_column('makahiki_profiles_profile', 'daily_visit_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Profile.last_visit_date'
        db.add_column('makahiki_profiles_profile', 'last_visit_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.theme'
        db.add_column('makahiki_profiles_profile', 'theme', self.gf('django.db.models.fields.CharField')(default='default', max_length=255), keep_default=False)

        # Deleting field 'Profile.daily_visit_count'
        db.delete_column('makahiki_profiles_profile', 'daily_visit_count')

        # Deleting field 'Profile.last_visit_date'
        db.delete_column('makahiki_profiles_profile', 'last_visit_date')
