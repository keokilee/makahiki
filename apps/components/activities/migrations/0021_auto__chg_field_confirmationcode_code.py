...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('activities_confirmationcode', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))


    def backwards(self, orm):
        
        # Changing field 'ConfirmationCode.code'
        db.alter_column('activities_confirmationcode', 'code', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 9, 14)'}),
