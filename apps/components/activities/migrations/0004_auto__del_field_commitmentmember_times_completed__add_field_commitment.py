...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommitmentMember.times_completed'
        db.delete_column('activities_commitmentmember', 'times_completed')

        # Adding field 'CommitmentMember.completion_date'
        db.add_column('activities_commitmentmember', 'completion_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 5, 5)), keep_default=False)

        # Changing field 'CommitmentMember.comment'
        db.alter_column('activities_commitmentmember', 'comment', self.gf('django.db.models.fields.TextField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Adding field 'CommitmentMember.times_completed'
        db.add_column('activities_commitmentmember', 'times_completed', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'CommitmentMember.completion_date'
        db.delete_column('activities_commitmentmember', 'completion_date')

        # Changing field 'CommitmentMember.comment'
        db.alter_column('activities_commitmentmember', 'comment', self.gf('django.db.models.fields.TextField')())
