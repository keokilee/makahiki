...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Like.object_type'
        db.delete_column('activities_like', 'object_type_id')

        # Adding field 'Like.content_type'
        db.add_column('activities_like', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Like.object_type'
        db.add_column('activities_like', 'object_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)

        # Deleting field 'Like.content_type'
        db.delete_column('activities_like', 'content_type_id')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 6, 22)'}),
