...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityBase.depends_on_text'
        db.add_column('activities_activitybase', 'depends_on_text', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True), keep_default=False)

        # Changing field 'ActivityBase.depends_on'
        db.alter_column('activities_activitybase', 'depends_on', self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True))

        # Changing field 'TextPromptQuestion.question'
        db.alter_column('activities_textpromptquestion', 'question', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Deleting field 'ActivityBase.depends_on_text'
        db.delete_column('activities_activitybase', 'depends_on_text')
        ...
        # Changing field 'TextPromptQuestion.question'
        db.alter_column('activities_textpromptquestion', 'question', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 31)'}),
