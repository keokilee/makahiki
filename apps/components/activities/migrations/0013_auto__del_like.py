...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Like'
        db.delete_table('activities_like')
    
    
    def backwards(self, orm):
        
        # Adding model 'Like'
        db.create_table('activities_like', (
        ...
        db.send_create_signal('activities', ['Like'])
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 7, 17)'}),
