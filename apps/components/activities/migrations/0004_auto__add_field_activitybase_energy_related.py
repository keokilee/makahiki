...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityBase.energy_related'
        db.add_column('activities_activitybase', 'energy_related', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActivityBase.energy_related'
        db.delete_column('activities_activitybase', 'energy_related')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 4, 5)'}),
