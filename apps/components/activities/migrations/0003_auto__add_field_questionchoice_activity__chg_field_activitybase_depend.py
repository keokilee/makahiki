...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuestionChoice.activity'
        db.add_column('activities_questionchoice', 'activity', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['activities.Activity']), keep_default=False)

        # Changing field 'ActivityBase.depends_on'
        db.alter_column('activities_activitybase', 'depends_on', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))

        # Changing field 'TextPromptQuestion.answer'
        db.alter_column('activities_textpromptquestion', 'answer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'QuestionChoice.activity'
        db.delete_column('activities_questionchoice', 'activity_id')

        # Changing field 'ActivityBase.depends_on'
        db.alter_column('activities_activitybase', 'depends_on', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'TextPromptQuestion.answer'
        db.alter_column('activities_textpromptquestion', 'answer', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 2, 24)'}),
        ...
        'activities.activitybase': {
            ...
            'depends_on': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
