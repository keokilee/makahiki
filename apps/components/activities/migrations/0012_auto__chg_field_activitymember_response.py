...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityMember.response'
        db.alter_column('activities_activitymember', 'response', self.gf('django.db.models.fields.TextField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'ActivityMember.response'
        db.alter_column('activities_activitymember', 'response', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True))
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 14)'}),
