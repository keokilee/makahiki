...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('activities_questionchoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.TextPromptQuestion'])),
            ('choice', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('activities', ['QuestionChoice'])


    def backwards(self, orm):
        
        # Deleting model 'QuestionChoice'
        db.delete_table('activities_questionchoice')
