...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CommonActivityUser.submission_date'
        db.delete_column('activities_commonactivityuser', 'submission_date')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 7, 24)'}),
