...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Commitment.category'
        db.add_column('activities_commitment', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Category'], null=True, blank=True), keep_default=False)

        # Adding field 'Activity.category'
        db.add_column('activities_activity', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Category'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Commitment.category'
        db.delete_column('activities_commitment', 'category_id')

        # Deleting field 'Activity.category'
        db.delete_column('activities_activity', 'category_id')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 10, 14)'}),
