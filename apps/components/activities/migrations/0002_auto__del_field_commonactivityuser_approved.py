...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommonActivityUser.approved'
        db.delete_column('activities_commonactivityuser', 'approved')
    
    
    def backwards(self, orm):
        
        # Adding field 'CommonActivityUser.approved'
        db.add_column('activities_commonactivityuser', 'approved', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
