...
class Migration(SchemaMigration):
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 23)'}),
        ...
        'activities.activitymember': {
            'Meta': {'unique_together': "(('user', 'activity'),)", 'object_name': 'ActivityMember', '_ormbases': ['activities.CommonActivityUser']},
