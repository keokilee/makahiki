...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.event_location'
        db.alter_column('activities_activity', 'event_location', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Activity.event_location'
        db.alter_column('activities_activity', 'event_location', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
