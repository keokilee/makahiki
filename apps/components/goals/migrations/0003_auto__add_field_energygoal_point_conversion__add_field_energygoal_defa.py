...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EnergyGoal.point_conversion'
        db.add_column('goals_energygoal', 'point_conversion', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Adding field 'EnergyGoal.default_goal'
        db.add_column('goals_energygoal', 'default_goal', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'EnergyGoal.point_conversion'
        db.delete_column('goals_energygoal', 'point_conversion')

        # Deleting field 'EnergyGoal.default_goal'
        db.delete_column('goals_energygoal', 'default_goal')
