...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('goals_floorenergygoal', 'completed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'FloorEnergyGoal.awarded'
        db.add_column('goals_floorenergygoal', 'awarded', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'FloorEnergyGoal.completed'
        db.delete_column('goals_floorenergygoal', 'completed')

        # Deleting field 'FloorEnergyGoal.awarded'
        db.delete_column('goals_floorenergygoal', 'awarded')
