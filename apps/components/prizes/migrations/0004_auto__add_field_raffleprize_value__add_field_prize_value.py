...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RafflePrize.value'
        db.add_column('prizes_raffleprize', 'value', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Adding field 'Prize.value'
        db.add_column('prizes_prize', 'value', self.gf('django.db.models.fields.IntegerField')(default=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RafflePrize.value'
        db.delete_column('prizes_raffleprize', 'value')

        # Deleting field 'Prize.value'
        db.delete_column('prizes_prize', 'value')
