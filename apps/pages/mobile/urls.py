...
#    url(r'^smartgrid/task/(\d+)/?$', 'pages.mobile.views.task', name='mobile_smartgrid_task'), 
    url(r'^smartgrid/(?P<activity_type>[\w\d\-]+)/?$', 'pages.mobile.views.sgactivities', name='mobile_activities'),
    url(r'^smartgrid/(?P<activity_type>[\w\d\-]+)/(?P<slug>[\w\d\-]+)/?$', 'pages.mobile.views.task', name='mobile_task'),
    url(r'^smartgrid/(?P<activity_type>[\w\d\-]+)/(?P<slug>[\w\d\-]+)/add/?$', 'pages.mobile.views.sgadd', name='mobile_smartgrid_add'),
