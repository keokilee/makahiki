...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('makahiki_profiles_profile', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
    
    
    def backwards(self, orm):
        
        # Changing field 'Profile.name'
        db.alter_column('makahiki_profiles_profile', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))
