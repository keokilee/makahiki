...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('activities_goalmember', (
            ('admin_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('user_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 9, 11)'}),
