...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommitmentMember.is_active'
        db.delete_column('activities_commitmentmember', 'is_active')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CommitmentMember.is_active'
        db.add_column('activities_commitmentmember', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
