...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoalMember.admin_comment'
        db.add_column('activities_goalmember', 'admin_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'GoalMember.admin_comment'
        db.delete_column('activities_goalmember', 'admin_comment')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 6, 9)'}),
