...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GoalMember.group'
        db.delete_column('activities_goalmember', 'group_id')

        # Adding field 'GoalMember.floor'
        db.add_column('activities_goalmember', 'floor', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['kukui_cup_floors.Floor']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'GoalMember.group'
        db.add_column('activities_goalmember', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['tribes.Tribe']), keep_default=False)

        # Deleting field 'GoalMember.floor'
        db.delete_column('activities_goalmember', 'floor_id')
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 5, 20)'}),
