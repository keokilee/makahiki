...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoalMember.user_comment'
        db.add_column('activities_goalmember', 'user_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'GoalMember.user_comment'
        db.delete_column('activities_goalmember', 'user_comment')
