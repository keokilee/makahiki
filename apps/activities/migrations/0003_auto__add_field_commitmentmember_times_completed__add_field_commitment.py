...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('activities_commitment', 'duration', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('activities_commitment', 'duration')
    ...
    models = {
        ...
        'activities.commitmentmember': {
            ...
            'times_completed': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
