...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.point_range_start'
        db.add_column('activities_activity', 'point_range_start', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Activity.point_range_end'
        db.add_column('activities_activity', 'point_range_end', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'Activity.point_value'
        db.alter_column('activities_activity', 'point_value', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Activity.point_range_start'
        db.delete_column('activities_activity', 'point_range_start')

        # Deleting field 'Activity.point_range_end'
        db.delete_column('activities_activity', 'point_range_end')

        # Changing field 'Activity.point_value'
        db.alter_column('activities_activity', 'point_value', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        'activities.activity': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 8, 20)'}),
