...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Floor.floor_identifier'
        db.add_column('floors_floor', 'floor_identifier', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Floor.floor_identifier'
        db.delete_column('floors_floor', 'floor_identifier')
