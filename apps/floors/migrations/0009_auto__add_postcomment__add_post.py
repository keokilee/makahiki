...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('floors_postcomment', (
            ('created_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['floors.Post'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('floors', ['PostComment'])

        # Adding model 'Post'
        db.create_table('floors_post', (
            ('floor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['floors.Floor'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('style_class', self.gf('django.db.models.fields.CharField')(default='user_post', max_length=50)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('floors', ['Post'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'PostComment'
        db.delete_table('floors_postcomment')

        # Deleting model 'Post'
        db.delete_table('floors_post')
