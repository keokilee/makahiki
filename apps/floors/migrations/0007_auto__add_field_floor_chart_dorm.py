...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('floors_floor', 'chart_dorm', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Floor.chart_dorm'
        db.delete_column('floors_floor', 'chart_dorm')
