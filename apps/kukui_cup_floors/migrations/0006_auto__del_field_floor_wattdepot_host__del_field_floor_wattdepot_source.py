...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('kukui_cup_floors_floor', 'chart_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Floor.chart_floor'
        db.add_column('kukui_cup_floors_floor', 'chart_floor', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('kukui_cup_floors_floor', 'chart_url')

        # Deleting field 'Floor.chart_floor'
        db.delete_column('kukui_cup_floors_floor', 'chart_floor')
